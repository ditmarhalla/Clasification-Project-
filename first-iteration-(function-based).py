...
print('Time it takes to convert the files: ', round(stoptimefile - timefile, 1), "seconds")
...
stop_time_classification = time.time()
print('Time it takes to classifie',number_of_vectors_untrained, "untrained vectors ", round(stop_time_classification - timefile, 1), "seconds")
print("."*100)
